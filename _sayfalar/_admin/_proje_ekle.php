...
?>
	<section id="icerik" class="buyuk">
        ...
        <form method="post" id="ajaxForm">
				<input type="hidden" name="frm" value="projeEkle"/>
				<div class="col-md-12">
					<label><input type="radio" name="tip" value="1" checked/> DEVAM EDEN PROJE</label>
                    <label><input type="radio" name="tip" value="2"/> TAMAMLANAN PROJE </label>
				</div>
				<div class="form-group col-md-12">
					<label class="control-label">Başlık:</label><br />
					<input type="text" class="form-control" placeholder="Proje Başlığı" name="baslik" required/>
				</div>
                <div class="form-group col-md-12">
            		Açıklama <br>
					...
					<div class="input-group">
						<span class="input-group-btn">
							<span class="btn btn-primary btn-file btn-md">
								Seç&hellip; <input type="file" name="proje" required>
							</span>
						</span>
						<input type="text" class="form-control input-md" required readonly>
					</div>
					<span class="help-block">
						Yeni Proje Resmini Yüklemek İçin Seç'e Tıkla. <span class="text-danger">Maksimum Boyut 1980x800 px ve Maksimum boyut 1 mb olmalı.</span>
					</span>
				</div>
				<div class="col-lg-12 col-sm-12 col-xs-12">
