...
?>
	...
	<section id="icerik" class="buyuk">
        ...
        <form method="post" id="ajaxForm">
				<input type="hidden" name="frm" value="devamedenprojeEkle"/>
				<div class="col-md-12">
				...
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<span class="help-block">
						Yeni Proje'yi Yüklemek İçin Seç'e Tıkla. <span class="text-danger">Maksimum Boyut 1980x800 px ve Maksimum boyut 1 mb olmalı.</span>
					</span>
				</div>
				<div class="col-lg-12 col-sm-12 col-xs-12">
